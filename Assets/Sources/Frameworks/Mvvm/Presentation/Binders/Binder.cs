...
namespace Presentation.Frameworks.Mvvm.Binders
{
    public class Binder : IBinder
    {
        ...
        private IBindableViewMethod GetBindableMethod(IBindableView view, MethodBindingAttribute bindingAttribute)
        {
        ...
        private IBindableViewProperty GetBindableProperty(IBindableView view, PropertyBindingAttribute bindingAttribute)
        {
            return (view as MonoBehaviour)?
                   .GetComponents(bindingAttribute.ComponentType)
                   .FirstOrDefault(childComponent => childComponent.name ==
